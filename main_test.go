...
/*
это тест на проверку того что это действительно конвейер
...
func TestPipeline(t *testing.T) {
	...
	freeFlowJobs := []job{
		job(func(in, out chan interface{}) {
			...
			// в чем тут суть
			// если накапливать значения, то пока вся функция не отработает - дальше они не пойдут
			// тут проверяется, что счетчик увеличился в следующей функции
...
func TestSigner(t *testing.T) {
	testExpected := "1842515611~1684880638_2212294583~709660146_2212294583~709660146_2226203566~3690458478_4108050209~502633748_4194326291~2004971030_450215437~1933333237"
